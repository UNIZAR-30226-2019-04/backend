...
class Usuario(db.Model):
    ...
    Imagen_Perfil_Path = db.Column(db.String(255), nullable=False, default="/var/www/html/profile/default.jpg")
    ...
    def decode_confirmation_token(confirmation_token):
        ...
        """
        try:
            payload = jwt.decode(confirmation_token, key, algorithms=['HS256'])
            return payload['sub']
        except jwt.ExpiredSignatureError:
